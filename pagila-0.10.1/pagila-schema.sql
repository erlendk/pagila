...
CREATE FUNCTION pagila_payment_insert_trigger() RETURNS trigger
    ...
    AS $$
BEGIN
	IF (NEW.tarih >= '2007-01-01' AND NEW.tarih < '2007-02-01' ) THEN
		INSERT INTO payment_p2007_01 VALUES (NEW.*);
	ELSIF (NEW.tarih >= '2007-02-01' AND NEW.tarih < '2007-03-01' ) THEN
                INSERT INTO payment_p2007_02 VALUES (NEW.*);
	ELSIF (NEW.tarih >= '2007-03-01' AND NEW.tarih < '2007-04-01' ) THEN
                INSERT INTO payment_p2007_03 VALUES (NEW.*);
	ELSIF (NEW.tarih >= '2007-04-01' AND NEW.tarih < '2007-05-01' ) THEN
                INSERT INTO payment_p2007_04 VALUES (NEW.*);
	ELSIF (NEW.tarih >= '2007-05-01' AND NEW.tarih < '2007-06-01' ) THEN
                INSERT INTO payment_p2007_05 VALUES (NEW.*);
	ELSIF (NEW.tarih >= '2007-06-01' AND NEW.tarih < '2007-07-01' ) THEN
                INSERT INTO payment_p2007_06 VALUES (NEW.*);
	ELSE
...
--
-- Name: pagila_payment_insert_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--
